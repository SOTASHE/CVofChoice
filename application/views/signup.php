            ...
            <form class="text-center">
                  <div class="form-row py-2 pt-5">
                      <div class="offset-2 col-lg-8 text-center">
                         <input type="text" class="inp px-3 text-center" placeholder="Firstname (s) "style="color:rgb(105, 105, 236);" required>
                       </div>
                   </div>
                   ...
                   <div class="form-row py-2">
                    ...
                    <div class="form-row py-2">
                          <div class="offset-2 col-lg-8">
                                <input type="digit" class="inp px-3 text-center" placeholder="Cellphone " style="color:rgb(105, 105, 236);" required>
                          </div>
                    </div>
                    ...
                    <div class="form-row py-2">
                          <div class="offset-2 col-lg-8">
                                <input type="digit" class="inp px-3 text-center" placeholder="Date of Birth " style="color:rgb(105, 105, 236);" required>
                          </div>
                    </div>

                    <div class="form-row py-2">
                          <div class="offset-2 col-lg-8 ">
                                <input type="digit" class="inp px-3 text-center " placeholder="ID Number " style="color:rgb(105, 105, 236);" required>
                          </div>
                    </div>
