...
<div class="container the-container py-1" >
<h1 class="animate__animated animate__pulse header-adjuster ">Increasing access to employment .</h1>
    <div class="row" style="padding:20px;">
        <!--middle screen icons below-->
