            ...
            <form class="text-center">
                  <div class="form-row py-2 pt-5">
                      <div class="offset-2 col-lg-8 text-center">
                         <input type="text" class="input-field px-3 text-center" placeholder= "Country of Origin" style="color:rgb(105, 105, 236);" required>
                       </div>
                   </div>
                    
                   <div class="form-row py-2">
                          <div class="offset-2 col-lg-8">
                                <input type="text" class="input-field px-3 text-center" placeholder="Year Matriculated " style="color:rgb(105, 105, 236);" required>
                          </div>
                    </div>

                    <div class="form-row py-2">
                          <div class="offset-2 col-lg-8">
                                <input type="text" class="input-field px-3 text-center" placeholder="High School Name" style="color:rgb(105, 105, 236);" required>
                          </div>
                    </div>

                    <div class="form-row py-2">
                          <div class="offset-2 col-lg-8">
                                <input type="text" class="input-field px-3 text-center" placeholder="Qualification" style="color:rgb(105, 105, 236);" required>
                          </div>
                    </div>
                    <div class="form-row py-2">
                          <div class="offset-2 col-lg-8">
                                <input type="text" class="input-field px-3 text-center" placeholder="Institution" style="color:rgb(105, 105, 236);" required>
                          </div>
                    </div>

                    <div class="form-row py-2">
                          <div class="offset-2 col-lg-8">
                                <input type="text" class="input-field px-3 text-center" placeholder="Other Qualification (s)" style="color:rgb(105, 105, 236);" required>
                          </div>
                    </div>
  ...
  <hr/>
           <div class="py-5 mb-5 flex-center " >
            ...
            <div  class=" blue-background footer-copyright text-center py-3 mx-2">© 2022 Copyright:
                <a href="#" style=" text-decoration: none !important;" class="blue-background">CV of Choice</a>
