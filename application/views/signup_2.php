            ...
            <form class="text-center">
                  <div class="form-row py-2 pt-5">
                      <div class="offset-2 col-lg-8 text-center">
                         <input type="text" class="inp px-3 text-center" placeholder= "Country of Origin" style="color:rgb(105, 105, 236);" required>
                       </div>
                   </div>
                    
                   <div class="form-row py-2">
                          <div class="offset-2 col-lg-8">
                                <input type="text" class="inp px-3 text-center" placeholder="Year Matriculated " style="color:rgb(105, 105, 236);" required>
                          </div>
                    </div>

                    <div class="form-row py-2">
                          <div class="offset-2 col-lg-8">
                                <input type="text" class="inp px-3 text-center" placeholder="High School Name" style="color:rgb(105, 105, 236);" required>
                          </div>
                    </div>

                    <div class="form-row py-2">
                          <div class="offset-2 col-lg-8">
                                <input type="text" class="inp px-3 text-center" placeholder="Qualification" style="color:rgb(105, 105, 236);" required>
                          </div>
                    </div>
                    <div class="form-row py-2">
                          <div class="offset-2 col-lg-8">
                                <input type="text" class="inp px-3 text-center" placeholder="Institution" style="color:rgb(105, 105, 236);" required>
                          </div>
                    </div>

                    <div class="form-row py-2">
                          <div class="offset-2 col-lg-8">
                                <input type="text" class="inp px-3 text-center" placeholder="Other Qualification (s)" style="color:rgb(105, 105, 236);" required>
                          </div>
                    </div>
                      ...
                      <div class="form-row py-3 white-text">
                                ...
                                <div class="offset-6 col-lg-3">
                                       <form method="" action="<?php  echo base_url(); ?>​../Signup/signup2">
                                           <button id=""  type="submit" class="btn1">Next</button>
                                       </form>
                                </div>
