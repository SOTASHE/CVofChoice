    ...
    <div style="position:fixed;"class="container-fluid blue-navbar" >
        <a class="navbar-brand" href="#">
          <div class="logo-image">
           <img src="<?=base_url()?>../assets/images/3.png" class="img-circle img-fluid"  alt="our logo" width="140" height="130">
          </div>
        </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          <form style="color: white;" class="d-flex">
             <input style="color: rgb(105, 105, 236);" class="form-control me-2" type="search" placeholder="experience level" aria-label="Search">
             <input style="color: rgb(105, 105, 236);" class="form-control me-2" type="search" placeholder="qualification title" aria-label="Search">
